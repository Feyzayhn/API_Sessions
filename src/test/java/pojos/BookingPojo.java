...
public class BookingPojo {
    ...
    private BookingDatesPojo bookingdates; // BUNU BookingDatesPojo clasinda olusturdugum icin data tipi olarak bunu yaziyorum
    ...
    public BookingPojo() {  // PARAMETRESİZ
    }
    ...
    // 4) toString() methodunu olusturuyoruz BURASİ YAZDİRMAYA YARİYOR
    @Override
